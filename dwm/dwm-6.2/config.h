...
static const char dmenufont[]       = "FuraCode Nerd Font:size=12"; /* DejaVuSansMono Nerd Font */
...
static const char *dmenucmd[] = { "rofi","-show", "run", "-theme", "solarized", NULL };
...
static const char *upmicro[]   = { "amixer", "set", "Capture", "5+",     NULL };
static const char *downmicro[] = { "amixer", "set", "Capture", "5-",     NULL };
static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
	{ MODKEY|ShiftMask,             XK_Return, spawn,          {.v = termcmd } },
	{ METAKEY,               		XK_l, 	   spawn,          {.v = slockcmd } },
	{ 0,                            XK_Print,  spawn,          {.v = flameshot } },
	{ MODKEY,                       XK_F7,     spawn,          {.v = upvol } },
	{ MODKEY,                       XK_F8,     spawn,          {.v = downvol } },
	{ MODKEY,                       XK_F10,    spawn,          {.v = upmicro } },
	{ MODKEY,                       XK_F11,    spawn,          {.v = downmicro } },
